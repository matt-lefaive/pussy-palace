...
const CatWalk = ({ loadObjectEvents }) => {
    ...
    const soundbites = {
        'mallette': {
            ...
            citation: 'Mallette, T. (Narrator). (2022). The cat walk: 23-inch bells [Audio soundbite]. In The history of the Pussy Palace: A digital exhibit. LGBTQ Oral History Digital Collaboratory. https://URL of soundbite webpage location',
        ...
        'roberton': {
            ...
            citation: 'Roberton, T. (Narrator). (2022). The cat walk: Leather femdom [Audio soundbite]. In The history of the Pussy Palace: A digital exhibit. LGBTQ Oral History Digital Collaboratory. https://URL of soundbite webpage location',
        ...
        'tough-sweet': {
            ...
            citation: 'Beever, A., & Woodward, R. (Narrators). (2022). The cat walk: Tough & Sweet [Audio soundbite]. In The history of the Pussy Palace: A digital exhibit. LGBTQ Oral History Digital Collaboratory. https://URL of soundbite webpage location',
        ...
        'irwin': {
            ...
            citation: 'Irwin, N. (Narrator). (2022). The cat walk: Naughty Nancy’s latex & toys [Audio soundbite]. In The history of the Pussy Palace: A digital exhibit. LGBTQ Oral History Digital Collaboratory. https://URL of soundbite webpage location',
        ...
        'campbell-smith': {
            ...
            citation: 'Campbell-Smith, N. (Narrator). (2022). The cat walk: Leather pants with a fringe [Audio soundbite]. In The history of the Pussy Palace: A digital exhibit. LGBTQ Oral History Digital Collaboratory. https://URL of soundbite webpage location',
        ...
        'dutrizac': {
            ...
            citation: 'Dutrizac, S. (Narrator). (2022). The cat walk: Getting dirty [Audio soundbite]. In The history of the Pussy Palace: A digital exhibit. LGBTQ Oral History Digital Collaboratory. https://URL of soundbite webpage location',
